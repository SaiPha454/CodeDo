    ...
    new_test_case.innerHTML = f"""
        ...
        <div class='parameters-section'>
            <div class='parameters-header'>
                ...
                <button class='add-param-button' data-test-case-id='{new_test_case_id}' mpy-click='add_parameter'>
            ...
            <div class='parameter-inputs' id='test-case-{new_test_case_id}-params'></div>
        </div>
